...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ConvertDialog_t, stringdata) + ofs \
...
const QMetaObject ConvertDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ConvertDialog.data,
      qt_meta_data_ConvertDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ConvertDialog.stringdata))
